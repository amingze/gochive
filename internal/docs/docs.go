...
const docTemplate = `{
    ...
    "info": {
        ...
        "contact": {
            "name": "API Support",
            "url": "https://github.com/amingze/gochive"
        },
        "license": {
            "name": "Apache 2.0",
            "url": "https://github.com/amingze/gochive/blob/master/LICENSE"
        },
        "version": "{{.Version}}"
    },
    "host": "{{.Host}}",
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/bind.BodyMemoCreation"
                        }
                    }
                ],
                "responses": {
